# GitHub Copilot Instructions — Project Starter

**Purpose:** Starter template for `.github/copilot-instructions.md`. Copy to your project, fill in project-specific sections, and commit.

**Source:** `global-configs/templates/copilot-instructions.starter.md`
**Extracted from guideline version:** 2026-05-28
**How to use:** Search for `[FILL]` and replace. This file is optimized for GitHub Copilot's instruction format.

---

## Project Identity

[FILL: 2-3 sentences describing project, institution, and core domains]
...
Never introduce `any` casts, `eslint-disable`, or `@ts-ignore` without a comment explaining why.
...
[FILL — Add project-specific rules, component mandates, design tokens, etc.]
...
- **Source of truth:** ``
- **Quarterly:** Re-extract rules from source guidelines
- **When guidelines change:** Update extracted rules
